package com.linghong.fkdp.config;


import com.linghong.fkdp.filter.ShiroLoginFilter;
import com.linghong.fkdp.shiro.ShiroHashedCredentialsMatcher;
import com.linghong.fkdp.shiro.ShiroRealm;
...
//        filters.put("kickout",kickOutUserFilter());
        ...
        urls.put("/user/getCurrentUserMessage", "authc");
        ...
        urls.put("/pay/getDetailBill/*", "authc");
