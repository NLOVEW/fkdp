...
public class OpenUserService {
    ...
    public User qqCallBack(HttpServletRequest request) {
        ...
        if (user != null){
            ...
            target.setNickName(qqUser.getNickname());
            target.setOpenId(accessToken.getOpenid());
    ...
    public User wxCallBack(HttpServletRequest request) {
    ...
    public User wbCallBack(HttpServletRequest request) {
        ...
        User user = userRepository.findByOpenUser_OpenId(accessToken.getUid());
        if (user != null){
            OpenUser target = user.getOpenUser();
            target.setAccessToken(accessToken.getAccess_token());
